...
function BillContent({ order, hotelName = "Regalia Resort" }: Props) {
  return (
    <div
      style={{
...
export default function KOTBillPrint({ order, hotelName }: Props) {
  ...
  return (
    <>
      ...
      <div style={{ position: "absolute", left: "-9999px", top: 0 }}>
        <div ref={printRef}>
          <BillContent order={order} hotelName={hotelName} />
        </div>
      </div>
