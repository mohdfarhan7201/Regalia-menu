# Deployment Guide — Regalia Digital Menu
...
| Role         | Email               | Password   |
| ------------ | ------------------- | ---------- |
| Admin        | admin@regalia.com   | admin123   |
| Captain      | captain@regalia.com | captain123 |
| Kitchen      | kitchen@regalia.com | kitchen123 |
| Cashier      | cashier@regalia.com | cashier123 |
| Lead Manager | leads@regalia.com   | leads123   |
